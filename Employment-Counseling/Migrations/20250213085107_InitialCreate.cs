    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageQuestionnaires", x => new { x.PackageId, x.QuestionnaireId });
                    table.ForeignKey(
                        name: "FK_PackageQuestionnaires_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageQuestionnaires_Questionnaires_QuestionnaireId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageQuestionnaires_QuestionnaireId",
                table: "PackageQuestionnaires",
